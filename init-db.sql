...
-- テスト用スレッドデータ（あいみょんコミュニティ、25件）
INSERT INTO threads (artist_id, title, created_by, created_at) VALUES
    ('aimyon', 'ライブの感想を語ろう！', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-13 10:00:00'),
    ('aimyon', 'おすすめの曲を教えてください', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-12 15:30:00'),
    ('aimyon', '新曲「風になりたい」の感想', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-11 09:00:00'),
    ('aimyon', 'ファンクラブイベント参加した方いますか？', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-10 20:00:00'),
    ('aimyon', 'マリーゴールドが好きな人集合', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-09 14:00:00'),
    ('aimyon', 'カラオケで歌いやすい曲は？', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-08 11:00:00'),
    ('aimyon', 'ギター弾き語りしてる人いますか', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-07 16:30:00'),
    ('aimyon', '歌詞の解釈について語りたい', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-06 08:00:00'),
    ('aimyon', 'アルバムのおすすめ順番', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-05 19:00:00'),
    ('aimyon', 'ライブグッズの交換希望', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-04 13:00:00'),
    ('aimyon', 'あいみょんの魅力を語る', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-03 10:00:00'),
    ('aimyon', 'MVの考察スレ', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-02 22:00:00'),
    ('aimyon', '初めてライブに行く方へ', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-01 07:00:00'),
    ('aimyon', 'セットリスト予想', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-31 18:00:00'),
    ('aimyon', 'コラボ曲について', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-30 12:00:00'),
    ('aimyon', 'ラジオ出演情報まとめ', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-29 09:00:00'),
    ('aimyon', 'テレビ出演の感想', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-28 21:00:00'),
    ('aimyon', 'あいみょん好きな有名人', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-27 15:00:00'),
    ('aimyon', '弾き語りアレンジ共有', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-26 10:00:00'),
    ('aimyon', 'ツアーの思い出を語ろう', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-25 14:00:00'),
    ('aimyon', '雑談スレッド', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-24 08:00:00'),
    ('aimyon', '歌詞ノートを見せ合おう', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-23 17:00:00'),
    ('aimyon', 'フェス参戦報告', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-22 11:00:00'),
    ('aimyon', 'あいみょん聖地巡礼', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-21 09:00:00'),
    ('aimyon', '自己紹介スレッド', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-20 06:00:00')
ON CONFLICT DO NOTHING;

-- テスト用コメントデータ（スレッド1に15件のコメント）
INSERT INTO thread_comments (thread_id, content, created_by, created_at) VALUES
    (1, 'ライブ最高でした！特にアンコールが感動的でした。', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-13 10:05:00'),
    (1, '私も行きました！MCが面白かったですよね。', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-13 10:10:00'),
    (1, '次のツアーも絶対行きたい！チケット争奪戦頑張りましょう。', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-13 10:15:00'),
    (1, 'セットリストが神でした。新曲も良かったけど、定番曲の盛り上がりが最高。', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-13 10:20:00'),
    (1, '会場の雰囲気も最高でしたね。みんなで一体になって歌った瞬間が忘れられません。', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-13 10:25:00'),
    (1, 'グッズも可愛かったです。タオルとTシャツ買いました！', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-13 10:30:00'),
    (1, '初めてのライブだったけど、すごく楽しかった。ファンになって良かった。', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-13 10:35:00'),
    (1, '音響が良かった！特にバラード曲の時は鳥肌が立ちました。', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-13 10:40:00'),
    (1, 'アンコールで泣いてる人がたくさんいましたね。', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-13 10:45:00'),
    (1, '地方公演にも行く予定の人いますか？', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-13 10:50:00'),
    (1, '大阪公演行きます！楽しみ！', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-13 10:55:00'),
    (1, '写真撮影OKの場所があって嬉しかったです。', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-13 11:00:00'),
    (1, '来年もツアーあるといいな。毎年恒例にしてほしい。', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-13 11:05:00'),
    (1, 'ライブ後のご飯も楽しみのひとつですよね。', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-13 11:10:00'),
    (1, '最高の思い出になりました！みなさんありがとう！', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-13 11:15:00'),
    (2, '「マリーゴールド」は名曲ですよね。', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-12 15:35:00'),
    (2, '「裸の心」もおすすめです！歌詞がすごく良い。', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-12 16:00:00'),
    (2, '「ハルノヒ」聴いてみてください。映画の主題歌にもなった曲です。', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-12 16:30:00'),
    (3, '新曲すごく良かったです！リピートが止まらない。', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-11 09:30:00'),
    (3, 'MVの世界観も素敵でしたね。', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-11 10:00:00')
ON CONFLICT DO NOTHING;
