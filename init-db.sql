...
CREATE TABLE IF NOT EXISTS threads (
    ...
    latest_comment_content VARCHAR(200),
...
-- テスト用スレッドデータ（あいみょんコミュニティ、25件、UUIDv7形式、非正規化カラム付き）
INSERT INTO threads (thread_id, artist_id, title, created_by, created_at, latest_comment_content, latest_comment_at) VALUES
    (CAST('01970000-1000-7000-8000-000000000001' AS uuid), 'aimyon', 'ライブの感想を語ろう！', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-13 10:00:00', '最高の思い出になりました！みなさんありがとう！', '2025-04-13 11:15:00'),
    (CAST('01970000-1000-7000-8000-000000000002' AS uuid), 'aimyon', 'おすすめの曲を教えてください', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-12 15:30:00', '「ハルノヒ」聴いてみてください。映画の主題歌にもなった曲です。', '2025-04-12 16:30:00'),
    (CAST('01970000-1000-7000-8000-000000000003' AS uuid), 'aimyon', '新曲「風になりたい」の感想', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-11 09:00:00', 'MVの世界観も素敵でしたね。', '2025-04-11 10:00:00'),
    (CAST('01970000-1000-7000-8000-000000000004' AS uuid), 'aimyon', 'ファンクラブイベント参加した方いますか？', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-10 20:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000005' AS uuid), 'aimyon', 'マリーゴールドが好きな人集合', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-09 14:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000006' AS uuid), 'aimyon', 'カラオケで歌いやすい曲は？', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-08 11:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000007' AS uuid), 'aimyon', 'ギター弾き語りしてる人いますか', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-07 16:30:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000008' AS uuid), 'aimyon', '歌詞の解釈について語りたい', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-06 08:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000009' AS uuid), 'aimyon', 'アルバムのおすすめ順番', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-05 19:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-00000000000a' AS uuid), 'aimyon', 'ライブグッズの交換希望', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-04 13:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-00000000000b' AS uuid), 'aimyon', 'あいみょんの魅力を語る', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-03 10:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-00000000000c' AS uuid), 'aimyon', 'MVの考察スレ', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-04-02 22:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-00000000000d' AS uuid), 'aimyon', '初めてライブに行く方へ', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-04-01 07:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-00000000000e' AS uuid), 'aimyon', 'セットリスト予想', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-31 18:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-00000000000f' AS uuid), 'aimyon', 'コラボ曲について', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-30 12:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000010' AS uuid), 'aimyon', 'ラジオ出演情報まとめ', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-29 09:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000011' AS uuid), 'aimyon', 'テレビ出演の感想', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-28 21:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000012' AS uuid), 'aimyon', 'あいみょん好きな有名人', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-27 15:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000013' AS uuid), 'aimyon', '弾き語りアレンジ共有', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-26 10:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000014' AS uuid), 'aimyon', 'ツアーの思い出を語ろう', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-25 14:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000015' AS uuid), 'aimyon', '雑談スレッド', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-24 08:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000016' AS uuid), 'aimyon', '歌詞ノートを見せ合おう', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-23 17:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000017' AS uuid), 'aimyon', 'フェス参戦報告', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-22 11:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000018' AS uuid), 'aimyon', 'あいみょん聖地巡礼', CAST('01908b7e-1234-7000-8000-000000000002' AS uuid), '2025-03-21 09:00:00', NULL, NULL),
    (CAST('01970000-1000-7000-8000-000000000019' AS uuid), 'aimyon', '自己紹介スレッド', CAST('01908b7e-1234-7000-8000-000000000001' AS uuid), '2025-03-20 06:00:00', NULL, NULL)
ON CONFLICT DO NOTHING;
